...
router.get('/', async (req, res) => {
    ...
    })).filter(d=> !d.title.includes('Week A') && !d.title.includes('Week B')&& !d.category.includes('Nursery')&& !d.category.includes('Reception')&& !d.category.includes('Yr 1')&& !d.category.includes('Year 1')&& !d.category.includes('Yr 2') && !d.category.includes('Year 2') && !d.category.includes('Yr 3')&& !d.category.includes('Year 3')&& !d.category.includes('Yr 4')&& !d.category.includes('Year 4')&& !d.category.includes('Yr 5')&& !d.category.includes('Year 5')&& !d.category.includes('Yr 6')&& !d.category.includes('Year 6')&& !d.category.includes('Yr 7')&& !d.category.includes('Year 7')&& !d.category.includes('Yr 8')&& !d.category.includes('Year 8'))
