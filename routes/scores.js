...
router.get('/', async (req, res) => {
    ...
    })).filter(d => d.fullDate < today && d.fullDate > lastWeek && d.score !== "Cancelled" && d.score !== "Abandoned" && d.score !== "Postponed" && d.score !== "See Report" && d.team.includes('U14' || 'U15' || 'U16' || 'U17' || 'U18' || '1st' || '2nd' || '3rd' || '4th' || '5th'))
    res.json(scoresList)
})
